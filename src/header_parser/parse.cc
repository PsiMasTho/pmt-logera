...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 2}, // 4: line ('\x0a') ->  declare_variable '\x0a'
     {261, 1}, // 5: line ('\x0a') ->  '\x0a'
     {264, 1}, // 6: identifier (IDENT) ->  IDENT
     {262, 3}, // 7: declare_attribute (DECL_ATTR) ->  DECL_ATTR identifier ';'
     {262, 3}, // 8: declare_attribute (';') ->  declare_attribute identifier ';'
     {263, 3}, // 9: declare_variable (DECL_VAR) ->  DECL_VAR identifier ';'
     {263, 3}, // 10: declare_variable (';') ->  declare_variable identifier ';'
     {265, 1}, // 11: input_$ ->  input
};
