...
PI_ const s_productionInfo[] = 
{
     ...
     {264, 2}, // 3: line ('\x0a') ->  declare_attribute '\x0a'
     {264, 2}, // 4: line ('\x0a') ->  declare_variable '\x0a'
     {264, 1}, // 5: line ('\x0a') ->  '\x0a'
     {267, 1}, // 6: identifier (IDENT) ->  IDENT
     {268, 1}, // 7: attribute (ATTR) ->  ATTR
     {266, 2}, // 8: declare_variable (DECL_VAR) ->  DECL_VAR identifier
     {266, 2}, // 9: declare_variable ->  declare_variable attribute
     {265, 2}, // 10: declare_attribute (DECL_ATTR) ->  DECL_ATTR attribute
     {269, 1}, // 11: input_$ ->  input
};
