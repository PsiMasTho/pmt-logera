...
PI_ const s_productionInfo[] = 
{
     ...
     {264, 1}, // 3: line ->  declare_attribute
     {264, 1}, // 4: line ->  declare_variable
     {267, 1}, // 5: identifier (IDENT) ->  IDENT
     {268, 1}, // 6: attribute (ATTR) ->  ATTR
     {266, 2}, // 7: declare_variable (DECL_VAR) ->  DECL_VAR identifier
     {266, 2}, // 8: declare_variable ->  declare_variable attribute
     {265, 2}, // 9: declare_attribute (DECL_ATTR) ->  DECL_ATTR attribute
     {269, 1}, // 10: input_$ ->  input
};
