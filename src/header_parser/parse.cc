// Generated by Bisonc++ V6.04.04 on Fri, 07 Oct 2022 23:25:55 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {263, 2}, // 3: line ('\x0a') ->  declare_attribute '\x0a'
     {263, 3}, // 4: line ('\x0a') ->  declare_attribute assign_regex '\x0a'
     {263, 2}, // 5: line ('\x0a') ->  declare_variable '\x0a'
     {263, 1}, // 6: line ('\x0a') ->  '\x0a'
     {267, 1}, // 7: identifier (IDENT) ->  IDENT
     {268, 1}, // 8: attribute (ATTR) ->  ATTR
     {269, 1}, // 9: regular_expr (REGEX) ->  REGEX
     {266, 2}, // 10: declare_variable (DECL_VAR) ->  DECL_VAR identifier
     {266, 2}, // 11: declare_variable ->  declare_variable attribute
     {264, 2}, // 12: declare_attribute (DECL_ATTR) ->  DECL_ATTR attribute
     {265, 1}, // 13: assign_regex ->  regular_expr
     {265, 2}, // 14: assign_regex ->  assign_regex regular_expr
     {270, 1}, // 15: input_$ ->  input
};
