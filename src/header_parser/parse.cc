// Generated by Bisonc++ V6.04.04 on Tue, 11 Oct 2022 03:26:58 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 2}, // 3: line ('\x0a') ->  declare_attribute '\x0a'
     {261, 2}, // 4: line (EOF_) ->  declare_attribute EOF_
     {261, 2}, // 5: line ('\x0a') ->  declare_variable '\x0a'
     {261, 2}, // 6: line (EOF_) ->  declare_variable EOF_
     {261, 1}, // 7: line ('\x0a') ->  '\x0a'
     {264, 1}, // 8: identifier (IDENT) ->  IDENT
     {262, 3}, // 9: declare_attribute (DECL_ATTR) ->  DECL_ATTR identifier ';'
     {262, 3}, // 10: declare_attribute (';') ->  declare_attribute identifier ';'
     {263, 3}, // 11: declare_variable (DECL_VAR) ->  DECL_VAR identifier ';'
     {263, 3}, // 12: declare_variable (';') ->  declare_variable identifier ';'
     {265, 1}, // 13: input_$ ->  input
};
...
SR_ s_1[] =
{
    { { REQ_TOKEN}, {       8} },                     
    { {       261}, {       2} }, // line             
    { {       262}, {       3} }, // declare_attribute
    { {       263}, {       4} }, // declare_variable 
    { {        10}, {       5} }, // '\x0a'           
    { {       259}, {       6} }, // DECL_ATTR        
    { {       257}, {       7} }, // DECL_VAR         
    { {      EOF_}, { ACCEPT_} },                     
