...
PI_ const s_productionInfo[] = 
{
     ...
     {262, 2}, // 3: line (NEWLINE) ->  declare_attribute NEWLINE
     {262, 2}, // 4: line (EOF_) ->  declare_attribute EOF_
     {262, 2}, // 5: line (NEWLINE) ->  declare_variable NEWLINE
     {262, 2}, // 6: line (EOF_) ->  declare_variable EOF_
     {262, 1}, // 7: line (NEWLINE) ->  NEWLINE
     {265, 1}, // 8: identifier (IDENT) ->  IDENT
     {263, 3}, // 9: declare_attribute (DECL_ATTR) ->  DECL_ATTR identifier ';'
     {263, 3}, // 10: declare_attribute (';') ->  declare_attribute identifier ';'
     {264, 3}, // 11: declare_variable (DECL_VAR) ->  DECL_VAR identifier ';'
     {264, 3}, // 12: declare_variable (';') ->  declare_variable identifier ';'
     {266, 1}, // 13: input_$ ->  input
};
...
SR_ s_1[] =
{
    { { REQ_TOKEN}, {       8} },                     
    { {       262}, {       2} }, // line             
    { {       263}, {       3} }, // declare_attribute
    { {       264}, {       4} }, // declare_variable 
    { {       260}, {       5} }, // NEWLINE          
    { {       259}, {       6} }, // DECL_ATTR        
    { {       257}, {       7} }, // DECL_VAR         
    { {      EOF_}, { ACCEPT_} },                     
