// Generated by Bisonc++ V6.04.04 on Mon, 03 Oct 2022 22:00:15 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {264, 0}, // 1: input ->  <empty>
     {264, 2}, // 2: input ->  input line
     {265, 2}, // 3: line ('\x0a') ->  declare_attribute '\x0a'
     {265, 3}, // 4: line ('\x0a') ->  declare_attribute assign_regex '\x0a'
     {265, 2}, // 5: line ('\x0a') ->  declare_variable '\x0a'
     {265, 1}, // 6: line ('\x0a') ->  '\x0a'
     {269, 1}, // 7: identifier (IDENT) ->  IDENT
     {270, 1}, // 8: attribute (ATTR) ->  ATTR
     {271, 1}, // 9: regular_expr (REGEX) ->  REGEX
     {268, 2}, // 10: declare_variable (DECL_VAR) ->  DECL_VAR identifier
     {268, 2}, // 11: declare_variable ->  declare_variable attribute
     {266, 2}, // 12: declare_attribute (DECL_ATTR) ->  DECL_ATTR attribute
     {267, 1}, // 13: assign_regex ->  regular_expr
     {267, 2}, // 14: assign_regex ->  assign_regex regular_expr
     {272, 1}, // 15: input_$ ->  input
};
...
SR_ s_1[] =
{
    { { REQ_TOKEN}, {       8} },                     
    { {       265}, {       2} }, // line             
    { {       266}, {       3} }, // declare_attribute
    { {       268}, {       4} }, // declare_variable 
    { {        10}, {       5} }, // '\x0a'           
    { {       259}, {       6} }, // DECL_ATTR        
    { {       257}, {       7} }, // DECL_VAR         
    { {      EOF_}, { ACCEPT_} },                     
...
try
{
    ...
    switch (production)
    {
        ...
        case 8:
        {
         d_val_ = string(d_scanner.matched()).substr(1);
         }
        break;
        ...
        case 13:
        {
         d_ret->addRegexToLastAttr(vs_(0));
         }
        break;
