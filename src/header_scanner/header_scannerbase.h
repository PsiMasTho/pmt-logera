...
protected:
    ...
    HeaderScannerBase(std::string const& infilename,
...
inline HeaderScannerBase::StartCondition_ constexpr HeaderScannerBase::SC(
    int sc)
{
...
inline HeaderScannerBase::StartCondition_
HeaderScannerBase::startCondition() const
{
...
inline std::vector<HeaderScannerBase::StreamStruct> const&
HeaderScannerBase::streamStack() const
{
