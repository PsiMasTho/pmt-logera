...
PI_ const s_productionInfo[] = 
{
     ...
     {263, 2}, // 4: line (EOF_) ->  declare_attribute EOF_
     {263, 2}, // 5: line (NEWLINE) ->  declare_variable NEWLINE
     {263, 2}, // 6: line (EOF_) ->  declare_variable EOF_
     {263, 1}, // 7: line (NEWLINE) ->  NEWLINE
     {266, 1}, // 8: identifier (IDENT) ->  IDENT
     {264, 3}, // 9: declare_attribute (DECL_ATTR) ->  DECL_ATTR identifier ';'
     {264, 3}, // 10: declare_attribute (';') ->  declare_attribute identifier ';'
     {265, 3}, // 11: declare_variable (DECL_VAR) ->  DECL_VAR identifier ';'
     {265, 3}, // 12: declare_variable (';') ->  declare_variable identifier ';'
