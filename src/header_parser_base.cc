...
PI_ const s_productionInfo[] = 
{
     ...
     {265, 2}, // 3: line (NEWLINE) ->  declare_attribute NEWLINE
     {265, 2}, // 4: line (EOF_) ->  declare_attribute EOF_
     {265, 2}, // 5: line (NEWLINE) ->  declare_variable NEWLINE
     {265, 2}, // 6: line (EOF_) ->  declare_variable EOF_
     {265, 1}, // 7: line (NEWLINE) ->  NEWLINE
     {266, 3}, // 8: declare_attribute (DECL_ATTR) ->  DECL_ATTR identifier ';'
     {266, 3}, // 9: declare_attribute (';') ->  declare_attribute regex ';'
     {267, 3}, // 10: declare_variable (DECL_VAR) ->  DECL_VAR identifier ';'
     {267, 3}, // 11: declare_variable (';') ->  declare_variable identifier ';'
     {268, 1}, // 12: identifier (IDENT) ->  IDENT
     {269, 1}, // 13: regex (REGEX) ->  REGEX
     {270, 1}, // 14: input_$ ->  input
};
