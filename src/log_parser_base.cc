// Generated by Bisonc++ V6.06.00 on Mon, 13 Nov 2023 06:05:18 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {268, 2}, // 5: statement (NEWLINE) ->  variable NEWLINE
     {268, 2}, // 6: statement (EOF_) ->  variable EOF_
     {268, 2}, // 7: statement (NEWLINE) ->  attr_value_arr NEWLINE
     {268, 2}, // 8: statement (EOF_) ->  attr_value_arr EOF_
     {268, 1}, // 9: statement (NEWLINE) ->  NEWLINE
     {268, 1}, // 10: statement (EOF_) ->  EOF_
     {269, 3}, // 11: attr_value_pair (';') ->  identifier identifier ';'
     {270, 1}, // 12: attr_value_arr ->  attr_value_pair
     {270, 2}, // 13: attr_value_arr ->  attr_value_arr attr_value_pair
     {271, 2}, // 14: variable (':') ->  identifier ':'
     {272, 1}, // 15: identifier (IDENT) ->  IDENT
     {273, 1}, // 16: date (DATE) ->  DATE
     {274, 1}, // 17: input_$ ->  input
};
...
SR_ s_1[] =
{
    ...
    { {       273}, {       3} }, // date           
    { {       271}, {       4} }, // variable       
    { {       270}, {       5} }, // attr_value_arr 
    { {       260}, {       6} }, // NEWLINE        
    { {      EOF_}, {       7} }, // EOF_           
    { {       261}, {       8} }, // DATE           
    { {       272}, {       9} }, // identifier     
    { {       269}, {      10} }, // attr_value_pair
    { {       258}, {      11} }, // IDENT          
    { {      EOF_}, { ACCEPT_} },                   
    { {         0}, {       0} },                   
};
