// Generated by Bisonc++ V6.06.00 on Thu, 16 Nov 2023 01:57:00 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {270, 0}, // 1: input ->  <empty>
     {270, 2}, // 2: input ->  input statement
     {271, 2}, // 3: statement (NEWLINE) ->  date NEWLINE
     {271, 2}, // 4: statement (EOF_) ->  date EOF_
     {271, 2}, // 5: statement (NEWLINE) ->  variable NEWLINE
     {271, 2}, // 6: statement (EOF_) ->  variable EOF_
     {271, 2}, // 7: statement (NEWLINE) ->  attr_value_arr NEWLINE
     {271, 2}, // 8: statement (EOF_) ->  attr_value_arr EOF_
     {271, 1}, // 9: statement (NEWLINE) ->  NEWLINE
     {271, 1}, // 10: statement (EOF_) ->  EOF_
     {272, 3}, // 11: attr_value_pair (';') ->  identifier attr_value ';'
     {273, 1}, // 12: attr_value_arr ->  attr_value_pair
     {273, 2}, // 13: attr_value_arr ->  attr_value_arr attr_value_pair
     {274, 2}, // 14: variable (':') ->  identifier ':'
     {275, 1}, // 15: identifier (IDENT) ->  IDENT
     {276, 1}, // 16: date (DATE) ->  DATE
     {277, 1}, // 17: attr_value (ATTR_VALUE) ->  ATTR_VALUE
     {278, 1}, // 18: input_$ ->  input
};
...
SR_ s_1[] =
{
    ...
    { {       276}, {       3} }, // date           
    { {       274}, {       4} }, // variable       
    { {       273}, {       5} }, // attr_value_arr 
    { {       260}, {       6} }, // NEWLINE        
    { {      EOF_}, {       7} }, // EOF_           
    { {       261}, {       8} }, // DATE           
    { {       275}, {       9} }, // identifier     
    { {       272}, {      10} }, // attr_value_pair
    { {       258}, {      11} }, // IDENT          
    { {      EOF_}, { ACCEPT_} },                   
    { {         0}, {       0} },                   
};
...
try
{
    ...
    switch (production)
    {
        ...
        case 11:
        {
         d_val_ = make_pair(vs_(-2).get<Tag_::STRING>(), vs_(-1).get<Tag_::STRING>());
         }
        break;
        ...
        case 15:
        {
         d_val_ = m_lexer.matched();
         }
        break;

        case 16:
        {
         d_val_ = log_date{m_lexer.matched()};
         }
        break;
