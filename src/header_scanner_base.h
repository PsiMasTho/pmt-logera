...
#ifndef header_scannerBASE_H_INCLUDED
#define header_scannerBASE_H_INCLUDED
...
private:
    ...
    size_t (header_scannerBase::*d_get)() = &header_scannerBase::getInput;
...
public:
    header_scannerBase(header_scannerBase const &other)             = delete;
...
protected:
    header_scannerBase(std::istream &in, std::ostream &out, bool keepCwd = true);
    header_scannerBase(std::string const &infilename, std::string const &outfilename, bool keepCwd = true);
    ~header_scannerBase();
...
inline size_t header_scannerBase::Input::lineNr() const
{
    return d_lineNr;
}
inline size_t header_scannerBase::Input::nPending() const
{
    return d_deque.size();
}
inline void header_scannerBase::Input::setPending(size_t size)
{
    d_deque.erase(d_deque.begin(), d_deque.end() - size);
}
inline void header_scannerBase::Input::close()
{
    delete d_in;
...
inline header_scannerBase::~header_scannerBase()
{
    d_input->close();
}

template <typename ReturnType, typename ArgType>
inline ReturnType constexpr header_scannerBase::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

// $insert startcondimpl
inline header_scannerBase::StartCondition_ constexpr header_scannerBase::SC(int sc)
{
    return as<StartCondition_>(sc);
}

inline int constexpr header_scannerBase::SC(StartCondition_ sc)
{
    return as<int>(sc);
}

inline header_scannerBase::StartCondition_ header_scannerBase::startCondition() const
{
    return SC(d_startCondition);
}

inline void header_scannerBase::begin(StartCondition_ startCondition)
{
    // d_state is reset to 0 by reset_()
    d_dfaBase_ = s_dfaBase_[d_startCondition = SC(startCondition)];
}

inline bool header_scannerBase::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr header_scannerBase::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline std::ostream &header_scannerBase::out()
{
    return *d_out;
}

inline void header_scannerBase::push(size_t ch)
{
    d_input->reRead(ch);
}

inline void header_scannerBase::push(std::string const &str)
{
    d_input->reRead(str, 0);
}


inline std::vector<header_scannerBase::StreamStruct> const &header_scannerBase::streamStack() const
{
...
inline void header_scannerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void header_scannerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &header_scannerBase::matched() const
{
    return d_matched;
}

inline std::string const &header_scannerBase::cwd() const
{
    return d_cwd;
}

inline std::string const &header_scannerBase::filename() const
{
    return d_filename;
}

inline void header_scannerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t header_scannerBase::length() const
{
    return d_matched.size();
}

inline void header_scannerBase::leave(int retValue) const
{
    throw as<Leave_>(retValue);
}

inline size_t header_scannerBase::lineNr() const
{
    return d_input->lineNr();
}

inline void header_scannerBase::more()
{
    d_more = true;
}

inline size_t header_scannerBase::state_() const
{
    return d_state;
}

inline size_t header_scannerBase::get_()
{
    return (this->*d_get)();
}

inline size_t header_scannerBase::getInput()
{
    return d_input->get();
}

inline bool header_scannerBase::return_()
{
    return d_return;
}

inline void header_scannerBase::noReturn_()
{
    d_return = false;
}


#endif //  header_scannerBASE_H_INCLUDED
