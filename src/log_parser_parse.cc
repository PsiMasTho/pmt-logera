// Generated by Bisonc++ V6.04.04 on Tue, 07 Nov 2023 23:47:41 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {265, 0}, // 1: input ->  <empty>
     {265, 2}, // 2: input ->  input statement
     {266, 2}, // 3: statement (NEWLINE) ->  date NEWLINE
     {266, 2}, // 4: statement (EOF_) ->  date EOF_
     {266, 2}, // 5: statement (NEWLINE) ->  variable NEWLINE
     {266, 2}, // 6: statement (EOF_) ->  variable EOF_
     {266, 2}, // 7: statement (NEWLINE) ->  attr_value_arr NEWLINE
     {266, 2}, // 8: statement (EOF_) ->  attr_value_arr EOF_
     {266, 1}, // 9: statement (NEWLINE) ->  NEWLINE
     {266, 1}, // 10: statement (EOF_) ->  EOF_
     {267, 3}, // 11: attr_value_pair (';') ->  identifier identifier ';'
     {268, 1}, // 12: attr_value_arr ->  attr_value_pair
     {268, 2}, // 13: attr_value_arr ->  attr_value_arr attr_value_pair
     {269, 2}, // 14: variable (':') ->  identifier ':'
     {270, 1}, // 15: identifier (IDENT) ->  IDENT
     {271, 1}, // 16: date (DATE) ->  DATE
     {272, 1}, // 17: input_$ ->  input
};
...
SR_ s_1[] =
{
    ...
    { {       271}, {       3} }, // date           
    { {       269}, {       4} }, // variable       
    { {       268}, {       5} }, // attr_value_arr 
    { {       259}, {       6} }, // NEWLINE        
    { {      EOF_}, {       7} }, // EOF_           
    { {       258}, {       8} }, // DATE           
    { {       270}, {       9} }, // identifier     
    { {       267}, {      10} }, // attr_value_pair
    { {       257}, {      11} }, // IDENT          
    { {      EOF_}, { ACCEPT_} },                   
    { {         0}, {       0} },                   
};
...
try
{
    ...
    switch (production)
    {
        ...
        case 16:
        {
         d_val_ = log_date{d_scanner.matched()};
         }
        break;
