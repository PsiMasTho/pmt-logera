...
PI_ const s_productionInfo[] = 
{
     ...
     {265, 2}, // 3: line ('\x0a') ->  date '\x0a'
     {265, 1}, // 4: line ->  assign_attributes
     {265, 1}, // 5: line ('\x0a') ->  '\x0a'
     {266, 1}, // 6: date (DATE) ->  DATE
     {268, 1}, // 7: value (VALUE) ->  VALUE
     {267, 5}, // 8: assign_attributes (':') ->  identifier ':' '\x0a' attribute value
     {267, 3}, // 9: assign_attributes ->  assign_attributes attribute value
     {267, 3}, // 10: assign_attributes ('\x0a') ->  '\x0a' attribute value
     {269, 1}, // 11: identifier (IDENT) ->  IDENT
     {270, 1}, // 12: attribute (ATTR) ->  ATTR
     {271, 1}, // 13: input_$ ->  input
};
