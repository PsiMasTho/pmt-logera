// Generated by Bisonc++ V6.04.04 on Wed, 12 Oct 2022 17:11:40 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 0}, // 1: input ->  <empty>
     {261, 2}, // 2: input ->  input line
     {262, 2}, // 3: line (NEWLINE) ->  date NEWLINE
     {262, 2}, // 4: line (NEWLINE) ->  variable NEWLINE
     {262, 2}, // 5: line (NEWLINE) ->  assign_vals_to_attrs NEWLINE
     {262, 2}, // 6: line (EOF_) ->  assign_vals_to_attrs EOF_
     {262, 1}, // 7: line (NEWLINE) ->  NEWLINE
     {263, 1}, // 8: date (DATE) ->  DATE
     {264, 1}, // 9: variable (VAR) ->  VAR
     {266, 1}, // 10: identifier (IDENT) ->  IDENT
     {265, 3}, // 11: assign_vals_to_attrs (';') ->  identifier identifier ';'
     {265, 4}, // 12: assign_vals_to_attrs (';') ->  assign_vals_to_attrs identifier identifier ';'
     {267, 1}, // 13: input_$ ->  input
};
...
try
{
    ...
    switch (production)
    {
        ...
        case 3:
        {
         d_logDataModifier.setDate(Date(vs_(-1)));
         }
        break;
        ...
        case 9:
        {
         ...
         txt.pop_back(); 
         d_logDataModifier.setActiveVar(txt);
         }
        break;
        ...
        case 11:
        {
         d_logDataModifier.addAttrToNewLine(vs_(-2), vs_(-1));
         }
        break;

        case 12:
        {
         d_logDataModifier.addAttrToCurrentLine(vs_(-2), vs_(-1));
         }
        break;
