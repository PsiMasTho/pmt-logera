// Generated by Bisonc++ V6.04.04 on Mon, 03 Oct 2022 12:34:33 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {263, 0}, // 1: input ->  <empty>
     {263, 2}, // 2: input ->  input line
     {264, 2}, // 3: line ('\x0a') ->  date '\x0a'
     {264, 1}, // 4: line ->  assign_attributes
     {264, 1}, // 5: line ('\x0a') ->  '\x0a'
     {265, 1}, // 6: date (DATE) ->  DATE
     {267, 1}, // 7: value (VALUE) ->  VALUE
     {266, 5}, // 8: assign_attributes (':') ->  identifier ':' '\x0a' attribute value
     {266, 3}, // 9: assign_attributes ->  assign_attributes attribute value
     {266, 3}, // 10: assign_attributes ('\x0a') ->  '\x0a' attribute value
     {268, 1}, // 11: identifier (IDENT) ->  IDENT
     {269, 1}, // 12: attribute (ATTR) ->  ATTR
     {270, 1}, // 13: input_$ ->  input
};
...
try
{
    ...
    switch (production)
    {
        ...
        case 3:
        {
         d_logData.setActiveDate(Date(vs_(-1)));
         }
        break;
        ...
        case 8:
        {
         d_logData.startNewLogLineForNewVar(vs_(-4));
         d_logData.addAttrToActiveVar(vs_(-1), vs_(0));
         }
        break;
