...
PI_ const s_productionInfo[] = 
{
     ...
     {262, 2}, // 3: line ('\x0a') ->  date '\x0a'
     {262, 1}, // 4: line ->  assign_attributes
     {262, 1}, // 5: line ('\x0a') ->  '\x0a'
     {263, 1}, // 6: date (DATE) ->  DATE
     {265, 1}, // 7: value (VALUE) ->  VALUE
     {264, 5}, // 8: assign_attributes (':') ->  identifier ':' '\x0a' attribute value
     {264, 3}, // 9: assign_attributes ->  assign_attributes attribute value
     {264, 3}, // 10: assign_attributes ('\x0a') ->  '\x0a' attribute value
     {266, 1}, // 11: identifier (IDENT) ->  IDENT
     {267, 1}, // 12: attribute (ATTR) ->  ATTR
...
try
{
    ...
    switch (production)
    {
        ...
        case 7:
        {
         d_val_ = std::string(d_scanner.matched()).substr(1); 
         }
        break;

        case 8:
        {
         d_logDataModifier.startNewLineForNewVar(vs_(-4));
         d_logDataModifier.addAttrToCurrentLine(vs_(-1), vs_(0));
         }
        break;
