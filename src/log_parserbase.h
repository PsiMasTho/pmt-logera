...
// hdr/includes
#ifndef log_parserBase_h_included
#define log_parserBase_h_included
...
{
    typedef std::optional<sparse_array<std::string>> type;
};

template <>
struct TypeOf<Tag_::LOG_DATE>
{
    typedef log_date type;
};
...
// $insert parserbase
class log_parserBase: public log_tokens
{
    public:
        enum DebugMode_
        {
...
// hdr/abort
inline void log_parserBase::ABORT() const
{
    throw PARSE_ABORT_;
}

// hdr/accept
inline void log_parserBase::ACCEPT() const
{
    throw PARSE_ACCEPT_;
}
...
// hdr/error
inline void log_parserBase::ERROR() const
{
    throw UNEXPECTED_TOKEN_;
}

// hdr/savedtoken
inline int log_parserBase::savedToken_() const
{
    return d_next.first;
}

// hdr/opbitand
inline log_parserBase::DebugMode_ operator&(log_parserBase::DebugMode_ lhs,
                                     log_parserBase::DebugMode_ rhs)
{
    return static_cast<log_parserBase::DebugMode_>(
...
inline log_parserBase::DebugMode_ operator|(log_parserBase::DebugMode_ lhs, 
                                     log_parserBase::DebugMode_ rhs)
{
    return static_cast<log_parserBase::DebugMode_>(static_cast<int>(lhs) | rhs);
};

// hdr/recovery
inline bool log_parserBase::recovery_() const
{
    return d_recovery;
}

// hdr/stacksize
inline size_t log_parserBase::stackSize_() const
{
    return d_stackIdx + 1;
}

// hdr/state
inline size_t log_parserBase::state_() const
{
    return d_state;
}

// hdr/token
inline int log_parserBase::token_() const
{
    return d_token;
}

// hdr/vs
inline log_parserBase::STYPE_ &log_parserBase::vs_(int idx) 
{
