...
template <>
struct TagOf<log_file_node>
{
    static Tag_ const tag = Tag_::LOG_FILE_NODE;
};
...
template <>
struct TagOf<variable_node>
{
    static Tag_ const tag = Tag_::VARIABLE_NODE;
};

template <>
struct TagOf<uint32_t>
{
    static Tag_ const tag = Tag_::OFFSET_T;
};
...
template <>
struct TypeOf<Tag_::LOG_FILE_NODE>
{
    using type = log_file_node;
};
...
{
    using type = variable_node;
};

template <>
struct TypeOf<Tag_::OFFSET_T>
{
    using type = uint32_t;
};
...
// $insert polymorphicOpAssignDecl
        ...
        SType &operator=(log_file_node const &value);
        SType &operator=(log_file_node &&tmp);
        ...
        SType &operator=(variable_node const &value);
        SType &operator=(variable_node &&tmp);

        SType &operator=(uint32_t const &value);
        SType &operator=(uint32_t &&tmp);
...
inline SType &SType::operator=(log_file_node const &value)
{
    assign< Tag_::LOG_FILE_NODE >(value);
    return *this;
}
inline SType &SType::operator=(log_file_node &&tmp)
{
    assign< Tag_::LOG_FILE_NODE >(std::move(tmp));
    return *this;
}
...
inline SType &SType::operator=(variable_node const &value)
{
    assign< Tag_::VARIABLE_NODE >(value);
    return *this;
}
inline SType &SType::operator=(variable_node &&tmp)
{
    assign< Tag_::VARIABLE_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(uint32_t const &value)
{
    assign< Tag_::OFFSET_T >(value);
    return *this;
}
inline SType &SType::operator=(uint32_t &&tmp)
{
    assign< Tag_::OFFSET_T >(std::move(tmp));
    return *this;
}
