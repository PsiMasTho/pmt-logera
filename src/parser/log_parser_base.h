...
template <>
struct TagOf<log_attr_value_node>
{
    static Tag_ const tag = Tag_::ATTR_VALUE_NODE;
};

template <>
struct TagOf<log_date_node>
{
    static Tag_ const tag = Tag_::DATE_NODE;
};

template <>
struct TagOf<log_identifier_node>
{
    static Tag_ const tag = Tag_::IDENTIFIER_NODE;
};

template <>
struct TagOf<log_ident_value_pair_list_node>
{
    static Tag_ const tag = Tag_::IDENT_VALUE_PAIR_LIST_NODE;
};

template <>
struct TagOf<log_variable_node>
{
    static Tag_ const tag = Tag_::VARIABLE_NODE;
};

template <>
struct TagOf<log_ident_value_pair_node>
{
    static Tag_ const tag = Tag_::IDENT_VALUE_PAIR_NODE;
};

template <>
struct TagOf<log_statement_node>
{
...
{
    using type = log_attr_value_node;
};

template <>
struct TypeOf<Tag_::DATE_NODE>
{
    using type = log_date_node;
};

template <>
struct TypeOf<Tag_::IDENTIFIER_NODE>
{
    using type = log_identifier_node;
};

template <>
struct TypeOf<Tag_::IDENT_VALUE_PAIR_LIST_NODE>
{
    using type = log_ident_value_pair_list_node;
};

template <>
struct TypeOf<Tag_::VARIABLE_NODE>
{
    using type = log_variable_node;
};

template <>
struct TypeOf<Tag_::IDENT_VALUE_PAIR_NODE>
{
    using type = log_ident_value_pair_node;
};

template <>
struct TypeOf<Tag_::STATEMENT_NODE>
{
    using type = log_statement_node;
};
...
public:
    ...
    SType& operator=(log_attr_value_node const& value);
    SType& operator=(log_attr_value_node&& tmp);

    SType& operator=(log_date_node const& value);
    SType& operator=(log_date_node&& tmp);

    SType& operator=(log_identifier_node const& value);
    SType& operator=(log_identifier_node&& tmp);

    SType& operator=(log_ident_value_pair_list_node const& value);
    SType& operator=(log_ident_value_pair_list_node&& tmp);

    SType& operator=(log_variable_node const& value);
    SType& operator=(log_variable_node&& tmp);

    SType& operator=(log_ident_value_pair_node const& value);
    SType& operator=(log_ident_value_pair_node&& tmp);

    SType& operator=(log_statement_node const& value);
    SType& operator=(log_statement_node&& tmp);
...
inline SType& SType::operator=(log_attr_value_node const& value)
{
    assign<Tag_::ATTR_VALUE_NODE>(value);
    return *this;
}
inline SType& SType::operator=(log_attr_value_node&& tmp)
{
    assign<Tag_::ATTR_VALUE_NODE>(std::move(tmp));
    return *this;
}
inline SType& SType::operator=(log_date_node const& value)
{
    assign<Tag_::DATE_NODE>(value);
    return *this;
}
inline SType& SType::operator=(log_date_node&& tmp)
{
    assign<Tag_::DATE_NODE>(std::move(tmp));
    return *this;
}
inline SType& SType::operator=(log_identifier_node const& value)
{
    assign<Tag_::IDENTIFIER_NODE>(value);
    return *this;
}
inline SType& SType::operator=(log_identifier_node&& tmp)
{
    assign<Tag_::IDENTIFIER_NODE>(std::move(tmp));
    return *this;
}
inline SType& SType::operator=(log_ident_value_pair_list_node const& value)
{
    assign<Tag_::IDENT_VALUE_PAIR_LIST_NODE>(value);
    return *this;
}
inline SType& SType::operator=(log_ident_value_pair_list_node&& tmp)
{
    assign<Tag_::IDENT_VALUE_PAIR_LIST_NODE>(std::move(tmp));
    return *this;
}
inline SType& SType::operator=(log_variable_node const& value)
{
    assign<Tag_::VARIABLE_NODE>(value);
    return *this;
}
inline SType& SType::operator=(log_variable_node&& tmp)
{
    assign<Tag_::VARIABLE_NODE>(std::move(tmp));
    return *this;
}
inline SType& SType::operator=(log_ident_value_pair_node const& value)
{
    assign<Tag_::IDENT_VALUE_PAIR_NODE>(value);
    return *this;
}
inline SType& SType::operator=(log_ident_value_pair_node&& tmp)
{
    assign<Tag_::IDENT_VALUE_PAIR_NODE>(std::move(tmp));
    return *this;
}
inline SType& SType::operator=(log_statement_node const& value)
{
    assign<Tag_::STATEMENT_NODE>(value);
    return *this;
}
inline SType& SType::operator=(log_statement_node&& tmp)
{
...
// hdr/opbitand
inline log_parser_base::DebugMode_ operator&(log_parser_base::DebugMode_ lhs, log_parser_base::DebugMode_ rhs)
{
