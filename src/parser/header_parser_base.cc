...
PI_ const s_productionInfo[] = {
    ...
    {268, 1}, // 5: statement ->  declare_attribute
    {268, 1}, // 6: statement ->  declare_variable
    {269, 3}, // 7: declare_attribute (DECL_ATTR) ->  DECL_ATTR identifier ';'
    {269, 3}, // 8: declare_attribute (';') ->  declare_attribute regex ';'
    {270, 3}, // 9: declare_variable (DECL_VAR) ->  DECL_VAR identifier ';'
    {270, 3}, // 10: declare_variable (';') ->  declare_variable identifier ';'
    {271, 1}, // 11: regex (REGEX) ->  REGEX
    {272, 1}, // 12: identifier (IDENT) ->  IDENT
    {273, 1}, // 13: input_$ ->  input
};
...
SR_ s_1[] = {
    ...
    {{260}, {3}}, // NEWLINE
    {{EOF_}, {4}}, // EOF_
    {{269}, {5}}, // declare_attribute
    {{270}, {6}}, // declare_variable
    {{258}, {7}}, // DECL_ATTR
    {{257}, {8}}, // DECL_VAR
    {{EOF_}, {ACCEPT_}},
    {{0}, {0}},
...
// State array:
SR_* s_state[] = {
    s_0, s_1, s_2, s_3, s_4, s_5, s_6, s_7, s_8, s_9, s_10, s_11, s_12, s_13, s_14, s_15, s_16, s_17, s_18,
};
...
// $insert idoftag
char const* idOfTag_[] = {"REGEX_NODE", "IDENTIFIER_NODE", "DECL_ATTR_NODE", "DECL_VAR_NODE", "STATEMENT_NODE", "EndPolyType_"};
...
try
{
    ...
    case 2: {
        std::get<header_root_node>(m_ast).children.push_back(vs_(0).get<Tag_::STATEMENT_NODE>());
    }
    break;
    ...
    case 7: {
        d_val_ = header_decl_attr_node{};
        d_val_.get<Tag_::DECL_ATTR_NODE>().children.push_back(vs_(-1).get<Tag_::IDENTIFIER_NODE>());
    }
    break;

    case 8: {
        vs_(-2).get<Tag_::DECL_ATTR_NODE>().children.push_back(vs_(-1).get<Tag_::REGEX_NODE>());
        d_val_ = vs_(-2).get<Tag_::DECL_ATTR_NODE>();
    }
    break;

    case 9: {
        d_val_ = header_decl_var_node{};
        d_val_.get<Tag_::DECL_VAR_NODE>().children.push_back(vs_(-1).get<Tag_::IDENTIFIER_NODE>());
    }
    break;

    case 10: {
        vs_(-2).get<Tag_::DECL_VAR_NODE>().children.push_back(vs_(-1).get<Tag_::IDENTIFIER_NODE>());
        d_val_ = vs_(-2).get<Tag_::DECL_VAR_NODE>();
    }
    break;

    case 11: {
        d_val_ = header_regex_node{};
        d_val_.get<Tag_::REGEX_NODE>().token_rec_idx = m_walker.get_cur_token_record_idx();
    }
    break;

    case 12: {
        d_val_ = header_identifier_node{};
