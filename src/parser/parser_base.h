...
#include <memory>
// $insert preincludes
#include "parser_base_preinclude.h"
...
template <>
struct TagOf<attr_value_node>
{
    static Tag_ const tag = Tag_::ATTR_VALUE_NODE;
};

template <>
struct TagOf<date_node>
{
    static Tag_ const tag = Tag_::DATE_NODE;
};

template <>
struct TagOf<regex_node>
{
    static Tag_ const tag = Tag_::REGEX_NODE;
};

template <>
struct TagOf<ident_value_pair_list_node>
{
    static Tag_ const tag = Tag_::IDENT_VALUE_PAIR_LIST_NODE;
};

template <>
struct TagOf<identifier_node>
{
    static Tag_ const tag = Tag_::IDENTIFIER_NODE;
};

template <>
struct TagOf<decl_attr_node>
{
    static Tag_ const tag = Tag_::DECL_ATTR_NODE;
};

template <>
struct TagOf<decl_var_node>
{
    static Tag_ const tag = Tag_::DECL_VAR_NODE;
};

template <>
struct TagOf<ident_value_pair_node>
{
    static Tag_ const tag = Tag_::IDENT_VALUE_PAIR_NODE;
};

template <>
struct TagOf<statement_node>
{
...
template <>
struct TypeOf<Tag_::ATTR_VALUE_NODE>
{
    using type = attr_value_node;
};

template <>
struct TypeOf<Tag_::DATE_NODE>
{
    using type = date_node;
};

template <>
struct TypeOf<Tag_::REGEX_NODE>
{
    using type = regex_node;
};

template <>
struct TypeOf<Tag_::IDENT_VALUE_PAIR_LIST_NODE>
{
    using type = ident_value_pair_list_node;
};

template <>
struct TypeOf<Tag_::IDENTIFIER_NODE>
{
    using type = identifier_node;
};

template <>
struct TypeOf<Tag_::DECL_ATTR_NODE>
{
    using type = decl_attr_node;
};

template <>
struct TypeOf<Tag_::DECL_VAR_NODE>
{
    using type = decl_var_node;
};

template <>
struct TypeOf<Tag_::IDENT_VALUE_PAIR_NODE>
{
    using type = ident_value_pair_node;
};

template <>
struct TypeOf<Tag_::STATEMENT_NODE>
{
    using type = statement_node;
};
...
// $insert polymorphicOpAssignDecl
        SType &operator=(attr_value_node const &value);
        SType &operator=(attr_value_node &&tmp);

        SType &operator=(date_node const &value);
        SType &operator=(date_node &&tmp);

        SType &operator=(regex_node const &value);
        SType &operator=(regex_node &&tmp);

        SType &operator=(ident_value_pair_list_node const &value);
        SType &operator=(ident_value_pair_list_node &&tmp);

        SType &operator=(identifier_node const &value);
        SType &operator=(identifier_node &&tmp);

        SType &operator=(decl_attr_node const &value);
        SType &operator=(decl_attr_node &&tmp);

        SType &operator=(decl_var_node const &value);
        SType &operator=(decl_var_node &&tmp);

        SType &operator=(ident_value_pair_node const &value);
        SType &operator=(ident_value_pair_node &&tmp);

        SType &operator=(statement_node const &value);
        SType &operator=(statement_node &&tmp);
...
inline SType &SType::operator=(attr_value_node const &value)
{
    assign< Tag_::ATTR_VALUE_NODE >(value);
    return *this;
}
inline SType &SType::operator=(attr_value_node &&tmp)
{
    assign< Tag_::ATTR_VALUE_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(date_node const &value)
{
    assign< Tag_::DATE_NODE >(value);
    return *this;
}
inline SType &SType::operator=(date_node &&tmp)
{
    assign< Tag_::DATE_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(regex_node const &value)
{
    assign< Tag_::REGEX_NODE >(value);
    return *this;
}
inline SType &SType::operator=(regex_node &&tmp)
{
    assign< Tag_::REGEX_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(ident_value_pair_list_node const &value)
{
    assign< Tag_::IDENT_VALUE_PAIR_LIST_NODE >(value);
    return *this;
}
inline SType &SType::operator=(ident_value_pair_list_node &&tmp)
{
    assign< Tag_::IDENT_VALUE_PAIR_LIST_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(identifier_node const &value)
{
    assign< Tag_::IDENTIFIER_NODE >(value);
    return *this;
}
inline SType &SType::operator=(identifier_node &&tmp)
{
    assign< Tag_::IDENTIFIER_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(decl_attr_node const &value)
{
    assign< Tag_::DECL_ATTR_NODE >(value);
    return *this;
}
inline SType &SType::operator=(decl_attr_node &&tmp)
{
    assign< Tag_::DECL_ATTR_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(decl_var_node const &value)
{
    assign< Tag_::DECL_VAR_NODE >(value);
    return *this;
}
inline SType &SType::operator=(decl_var_node &&tmp)
{
    assign< Tag_::DECL_VAR_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(ident_value_pair_node const &value)
{
    assign< Tag_::IDENT_VALUE_PAIR_NODE >(value);
    return *this;
}
inline SType &SType::operator=(ident_value_pair_node &&tmp)
{
    assign< Tag_::IDENT_VALUE_PAIR_NODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(statement_node const &value)
{
    assign< Tag_::STATEMENT_NODE >(value);
    return *this;
}
inline SType &SType::operator=(statement_node &&tmp)
{
...
// $insert parserbase
class parser_base: public tokens
{
    public:
        enum DebugMode_
        {
...
// hdr/abort
inline void parser_base::ABORT() const
{
    throw PARSE_ABORT_;
}

// hdr/accept
inline void parser_base::ACCEPT() const
{
    throw PARSE_ACCEPT_;
}
...
// hdr/error
inline void parser_base::ERROR() const
{
    throw UNEXPECTED_TOKEN_;
}

// hdr/savedtoken
inline int parser_base::savedToken_() const
{
    return d_next.first;
}

// hdr/opbitand
inline parser_base::DebugMode_ operator&(parser_base::DebugMode_ lhs,
                                     parser_base::DebugMode_ rhs)
{
    return static_cast<parser_base::DebugMode_>(
...
inline parser_base::DebugMode_ operator|(parser_base::DebugMode_ lhs, 
                                     parser_base::DebugMode_ rhs)
{
    return static_cast<parser_base::DebugMode_>(static_cast<int>(lhs) | rhs);
};

// hdr/recovery
inline bool parser_base::recovery_() const
{
    return d_recovery;
}

// hdr/stacksize
inline size_t parser_base::stackSize_() const
{
    return d_stackIdx + 1;
}

// hdr/state
inline size_t parser_base::state_() const
{
    return d_state;
}

// hdr/token
inline int parser_base::token_() const
{
    return d_token;
}

// hdr/vs
inline parser_base::STYPE_ &parser_base::vs_(int idx) 
{
