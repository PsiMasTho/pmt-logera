...
PI_ const s_productionInfo[] = {
    ...
    {268, 0}, // 1: input ->  <empty>
    {268, 2}, // 2: input ->  input statement
    {268, 2}, // 3: input (NEWLINE) ->  input NEWLINE
    {268, 2}, // 4: input (EOF_) ->  input EOF_
    {269, 1}, // 5: statement ->  date
    {269, 1}, // 6: statement ->  variable
    {269, 1}, // 7: statement ->  ident_value_pair_list
    {270, 2}, // 8: variable (':') ->  identifier ':'
    {271, 2}, // 9: ident_value_pair_list (';') ->  ident_value_pair ';'
    {271, 3}, // 10: ident_value_pair_list (';') ->  ident_value_pair_list ident_value_pair ';'
    {272, 2}, // 11: ident_value_pair ->  identifier attr_value
    {273, 1}, // 12: attr_value (ATTR_VALUE) ->  ATTR_VALUE
    {274, 1}, // 13: date (DATE) ->  DATE
    {275, 1}, // 14: identifier (IDENT) ->  IDENT
    {276, 1}, // 15: input_$ ->  input
};
...
// $insert idoftag
char const* idOfTag_[] = {"ATTR_VALUE_NODE",
                          "DATE_NODE",
                          "IDENTIFIER_NODE",
