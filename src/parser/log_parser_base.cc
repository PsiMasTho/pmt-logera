...
PI_ const s_productionInfo[] = {
    ...
    {261, 0}, // 1: input ->  <empty>
    {261, 2}, // 2: input ->  input statement
    {261, 2}, // 3: input (NEWLINE) ->  input NEWLINE
    {261, 2}, // 4: input (EOF_) ->  input EOF_
    {262, 1}, // 5: statement ->  date
    {262, 1}, // 6: statement ->  variable
    {262, 1}, // 7: statement ->  ident_value_pair_list
    {265, 2}, // 8: ident_value_pair_list (';') ->  ident_value_pair ';'
    {265, 3}, // 9: ident_value_pair_list (';') ->  ident_value_pair_list ident_value_pair ';'
    {264, 2}, // 10: variable (':') ->  identifier ':'
    {267, 1}, // 11: identifier (IDENT) ->  IDENT
    {263, 1}, // 12: date (DATE) ->  DATE
    {266, 1}, // 13: ident_value_pair (IDENT_VALUE_PAIR) ->  IDENT_VALUE_PAIR
    {268, 1}, // 14: input_$ ->  input
};
...
SR_ s_1[] = {
    ...
    {{263}, {5}}, // date
    {{264}, {6}}, // variable
    {{265}, {7}}, // ident_value_pair_list
    {{259}, {8}}, // DATE
    {{267}, {9}}, // identifier
    {{266}, {10}}, // ident_value_pair
    {{257}, {11}}, // IDENT
...
try
{
    ...
    case 5: {
        ...
        auto const this_node = ast_node{this_location, static_cast<u8>(log_node_enum::STATEMENT)};
        auto const this_idx = m_ast.add_node(this_node);
        m_ast.add_child(this_idx, vs_(0));
        d_val_ = this_idx;
    }
    break;
    ...
    case 8: {
        auto const this_location = m_walker.get_cur_token_record_source_location();
        auto const this_node = ast_node{this_location, static_cast<u8>(log_node_enum::IDENT_VALUE_PAIR_LIST)};
        auto const this_idx = m_ast.add_node(this_node);
        m_ast.add_child(this_idx, vs_(-1));
        d_val_ = this_idx;
    }
    break;

    case 9: {
        m_ast.add_child(vs_(-2), vs_(-1));
        d_val_ = vs_(-2);
    }
    break;
    ...
    case 10: {
        auto const this_location = m_walker.get_cur_token_record_source_location();
        auto const this_node = ast_node{this_location, static_cast<u8>(log_node_enum::VARIABLE)};
        auto const this_idx = m_ast.add_node(this_node);
        m_ast.add_child(this_idx, vs_(-1));
        d_val_ = this_idx;
    }
    ...
    case 11: {
        auto const this_location = m_walker.get_cur_token_record_source_location();
        auto const this_node = ast_node{this_location, static_cast<u8>(log_node_enum::IDENTIFIER)};
        auto const this_idx = m_ast.add_node(this_node);
        d_val_ = this_idx;
    }
    break;
    ...
    case 12: {
        auto const this_location = m_walker.get_cur_token_record_source_location();
        auto const this_node = ast_node{this_location, static_cast<u8>(log_node_enum::DATE)};
        auto const this_idx = m_ast.add_node(this_node);
        d_val_ = this_idx;
    }
    break;
    ...
    case 13: {
        auto const this_location = m_walker.get_cur_token_record_source_location();
        auto const this_node = ast_node{this_location, static_cast<u8>(log_node_enum::IDENT_VALUE_PAIR)};
        auto const this_idx = m_ast.add_node(this_node);
        d_val_ = this_idx;
    }
    break;
