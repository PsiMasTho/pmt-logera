...
static bool int_is_even(void const* ptr);

static bool int_is_prime(void const* ptr);

static void ov_test_struct_destroy(void* self);

static bool pred_always_true(void const* ptr);

static void test_opaque_vector_2d(void);

static void test_opaque_vector_begin_end_empty(void);

static void test_opaque_vector_begin_end(void);

static void test_opaque_vector_c_str(void);
